...
$$
  P[(T = 0)] = [X1 = 0, Y1= 0, X2=0, Y2=0, X3=0, Y3=0] = (p/2)^3 = (1/2)^3 = (1/2)^3 = 1/8
$$
$$
  P[(T = 6)] = [X1 = 1, Y1= 1, X2=1, Y2=1, X3=1, Y3=1] = (p/2)^3 = (1/2)^3 = (1/2)^3 = 1/8
$$
$$
  P(Rejecting\ H_o\ |\ H_o) = 1/8 + 1/8 = 2/8 = 1/4 - 0.25
$$
...
$$
Expanding the probability, and subsitute p=3/4 into the system since we are given Ho: p=3/4. We apply multiplication for 3 coin tosses here since each (X, Y) pairs are IID, and we have three pairs
$$
...
$$
  Statistical Power = 27/512 + 27/512 = 27/526 \approx 0.105
